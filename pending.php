...
<html>
	...
	<body>
		...
		if($rows_returned==0)
		{
			echo '<div style="clear:left;position:fixed;top:200px;">
				<div class="playarea" style="clear:left;position:fixed;top:200px;width:100%;bottom:0px;left:0px;overflow-x:hidden;overflow-y;scroll;">
					<p style="font-family:helvetica">No pending form available</p>
				</div>
				</div>';
		}
		else
		{
			...
			echo '<input type="radio" name="q1a" value="1">1
					<input type="radio" name="q1a" value="2">2
					<input type="radio" name="q1a" value="3">3
					<input type="radio" name="q1a" value="4">4
					<input type="radio" name="q1a" value="5">5
					<br/><br/><br/>';
					echo 'Q2)'.$forms_row['q2'].'<br/>'.'<br/>';
			echo '<input type="radio" name="q2a" value="1">1
					<input type="radio" name="q2a" value="2">2
					<input type="radio" name="q2a" value="3">3
					<input type="radio" name="q2a" value="4">4
					<input type="radio" name="q2a" value="5">5
					<br/><br/><br/>';
					echo 'Q3)'.$forms_row['q3'].'<br/>'.'<br/>';
			echo '<input type="radio" name="q3a" value="1">1
					<input type="radio" name="q3a" value="2">2
					<input type="radio" name="q3a" value="3">3
					<input type="radio" name="q3a" value="4">4
					<input type="radio" name="q3a" value="5">5
					<br/><br/><br/>';
					echo 'Q4)'.$forms_row['q4'].'<br/>'.'<br/>';
			echo '<input type="radio" name="q4a" value="1">1
					<input type="radio" name="q4a" value="2">2
					<input type="radio" name="q4a" value="3">3
					<input type="radio" name="q4a" value="4">4
					<input type="radio" name="q4a" value="5">5
					<br/><br/><br/>
